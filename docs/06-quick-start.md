...
| **[src/etl/credit_pipeline.py](src/etl/credit_pipeline.py)** | **[Credit Risk]** Pipeline 5 bước cào BCTC 1,447 doanh nghiệp niêm yết, tính Altman Z''-Score và nhãn rủi ro phá sản. |
| **[src/models/credit_risk_trainer.py](src/models/credit_risk_trainer.py)** | **[XGBoost ML]** Đọc dữ liệu, chia tập Train/Test theo chuỗi thời gian, huấn luyện mô hình XGBoost Classifier cảnh báo sớm kiệt quệ tài chính. |
