                ...
                try:
                    ...
                    if len(vn_win) >= 126:
                        ...
                        if is_valid_model(model_vn):
                            ...
                            # Pass the DataFrame slice (with 'trend' column) so HybridRegimeModel
                            # uses the proper branch instead of the stale-training-data fallback.
                            pk = model_vn.predict_proba(feat_win.iloc[-1:])[0]
