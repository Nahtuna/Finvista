...
def run_full_pipeline():
    ...
    from backend.modules.credit_risk.models.credit_step1_filter import filter_companies
    ...
    from backend.modules.credit_risk.models.credit_step2_crawl import crawl_financials
    crawl_financials(tickers)

    # Step 2.5: Structuring raw JSON data into CSV
    from backend.modules.credit_risk.etl.filter_raw_data import filter_and_clean_raw_data
    ...
    from backend.modules.credit_risk.etl.inspect_raw_data import inspect_raw_columns
    inspect_raw_columns()

    # Step 3: Compute Financial ratios & features
    from backend.modules.credit_risk.models.credit_step3_compute_features import compute_financial_features
    ...
    from backend.modules.credit_risk.models.credit_step4_label import label_financial_distress
    ...
    from backend.modules.credit_risk.models.credit_step5_export import export_final_dataset
