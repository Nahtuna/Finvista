...
from backend.infra.news_alerts import dispatch_news_alerts, dispatch_event_alerts

from backend.modules.trading_engine.ai_committee_service import AICommitteeService
from backend.modules.trading_engine.paper_trader import scan_and_trade
...
class FinvistaOrchestrator:
    ...
    def run_market_loop(self):
        ...
        try:
            from backend.modules.cw_pricing.backtest.scan_stock_setups import main as run_breakout_scanner
