...
class NewsImpactService:
    ...
    def run_full_pipeline(
        ...
        from backend.modules.news_impact.pipeline import run_full_pipeline
    ...
    def run_event_study(symbol: str, event_date: str, keyword: str = None) -> Dict[str, Any]:
        from backend.modules.news_impact.pipeline import run_event_study
    ...
    def _build_realtime_features(ticker: str) -> Optional[List[float]]:
        from backend.core.database import SessionLocal, StockHistoricalPrice, CorporateNews
