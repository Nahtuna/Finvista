...
def load_trade_history(username: str = "demo") -> list:
    ...
    from backend.modules.trading_engine.paper_trader import load_portfolio
...
def load_backtest_trades() -> list:
    ...
    try:
        from backend.modules.cw_pricing.backtest.opt_cw_backtest_audit import get_all_data, calc_indicators, run_strategy
        import pandas as pd
...
def print_advanced_stats(username: str = "demo", use_backtest: bool = False):
    ...
    print("-" * 100)
    from backend.modules.cw_pricing.backtest.industry_analyzer import IndustryAnalyzer
