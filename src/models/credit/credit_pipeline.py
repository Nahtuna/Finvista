...
def run_full_pipeline():
    ...
    from src.models.credit.credit_step1_filter import filter_companies
    ...
    from src.models.credit.credit_step2_crawl import crawl_financials
    crawl_financials(tickers)

    # Step 2.5: Structuring raw JSON data into CSV
    from src.etl.transformers.filter_raw_data import filter_and_clean_raw_data
    ...
    from src.etl.utils.inspect_raw_data import inspect_raw_columns
    inspect_raw_columns()

    # Step 3: Compute Financial ratios & features
    from src.models.credit.credit_step3_compute_features import compute_financial_features
    ...
    from src.models.credit.credit_step4_label import label_financial_distress
    ...
    from src.models.credit.credit_step5_export import export_final_dataset
