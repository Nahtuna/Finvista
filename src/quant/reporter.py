...
def print_terminal_report(final_df, args):
    ...
    print(f"  Trạng thái: {sent_indicator:<10} |  Basis hiện tại: {basis:>+5.2f} |  Basis SMA5: {basis_sma5:>+5.2f} |  Đà Basis: {basis_mom:>+5.2f} |  Đột biến KL Phái sinh: {vol_spike:>+5.1f}%")
    print("=" * 145)
