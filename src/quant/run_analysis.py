...
from src.quant.fetcher import fetch_market_cw_data, fetch_underlying_historical_volatilities
from src.quant.pricing_core import (
    fetch_dynamic_risk_free_rate,
    make_decision,
    score_cw,
)
from src.quant.ranker import run_quant_calculations, simulate_cw_scenarios
from src.quant.reporter import (
    REPORT_PATH,
...
def main():
    ...
    from src.quant import pricing_core
