...
def run_full_pipeline():
    ...
    from src.etl.credit_step1_filter import filter_companies
    ...
    from src.etl.credit_step2_crawl import crawl_financials
    ...
    from src.etl.filter_raw_data import filter_and_clean_raw_data
    ...
    from src.etl.inspect_raw_data import inspect_raw_columns
    inspect_raw_columns()
    
    # Step 3: Compute Financial ratios & features
    from src.etl.credit_step3_compute_features import compute_financial_features
    ...
    from src.etl.credit_step4_label import label_financial_distress
    ...
    from src.etl.credit_step5_export import export_final_dataset
